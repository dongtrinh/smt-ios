<?php
   ...
   function sendMessageThroughGCM($registatoin_ids, $message) {
		...
		define("GOOGLE_API_KEY", "AIzaSyDogrmGGTAGV5qpUiTEzTu7tviGYN7FwKQ"); 		
        $headers = array(
...
<html>
	...
	<body>
		...
		<form method="post" action="http://localhost/mytabapp/www/js/gcm.php?push=true" onSubmit="return checkTextAreaLen()">					                                                      
